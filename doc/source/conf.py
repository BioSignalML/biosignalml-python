...
copyright = u'2011-2013, David Brooks'
...
version = re.sub('(\d+\.\d+)\.\d+(.*)', r'\1\2', biosignalml.__version__)
version = re.sub(r'(\.\d+dev).*?$', r'\1', version)

# The full version, including alpha/beta/rc tags.
release = biosignalml.__version__
...
modindex_common_prefix = ['biosignalml.']
